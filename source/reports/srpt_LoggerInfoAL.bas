            ...
            Begin
                Begin ComboBox
                    ...
                    RowSource ="SELECT xref_Logger_Loc.Logger_ID, xref_Logger_Loc.Logger_Type, xref_Logger_Loc.L"
                        ...
                        "_Logger_Loc WHERE (((xref_Logger_Loc.Logger_Type)=\"Air\") AND ((xref_Logger_Loc"
                        ".LocationID)=[Forms]![frm_Events]![txt_Location_ID]) AND ((xref_Logger_Loc.Deplo"
                        "yed_Date)<=[Forms]![frm_Events]![txt_Start_Date]) AND ((xref_Logger_Loc.Removal_"
                        "Date) Is Null));"
                ...
                Begin Subform
                    ...
                    Name ="srpt_LoggerInfoALFouling"
                    SourceObject ="Report.srpt_LoggerInfoALFouling"
