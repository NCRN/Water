Operation =1
Option =0
Where ="(((tlu_Continuous_Loggers.Logger_Type_Code)=\"Baro\") AND ((xref_Logger_Loc.Depl"
    "oyed_Date) Is Null) AND ((xref_Logger_Loc.Removal_Date) Is Null)) OR (((tlu_Cont"
    "inuous_Loggers.Logger_Type_Code)=\"Baro\") AND ((xref_Logger_Loc.Deployed_Date) "
    "Is Not Null) AND ((xref_Logger_Loc.Removal_Date) Is Not Null))"
Begin InputTables
